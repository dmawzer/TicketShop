...
{
    public class GenericSaveMessageHandler<TModel> : IGenericMessageHandler<GenericSaveRequest<TModel>, GenericResponse<TModel>> where TModel :  AbstractDomainModel
    {
